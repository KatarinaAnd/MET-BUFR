...
#store some of the most important 

def table_020003(value):
    ...
    try:
        return present_weather(value)
    except:
        print('value does not exist in table 020003')

def table_020004(value):
    ...
    try:
        return past_weather1(value)
    except:
        print('value does not exist in table 020004')
        

def table_020005(value):
    past_weather1 = {'0': 'CLOUD COVERING 1/2 OR LESS OF THE SKY THROUGHOUT THE APPROPRIATE PERIOD',
                     '1': 'CLOUD COVERING MORE THAN 1/2 OF THE SKY DURING PART OF THE APPROPRIATE PERIOD AND COVERING 1/2 OR LESS DURING PART OF THE PERIOD',
                     '2': 'CLOUD COVERING MORE THAN 1/2 OF THE SKY THROUGHOUT THE APPROPRIATE PERIOD',
                     '3': 'SANDSTORM, DUSTSTORM OR BLOWING SNOW',
    ...
    try:
        ...
        print('value does not exist in table 020005')
        
def table_008021(value):
    ...
    try:
        return time_significance(value)
    except:
        print('value does not exist in table 008021')

def table_020062(value):
    state_of_the_ground = {
    ...
    try:
        return state_of_the_ground(value)
    except:
        print('value does not exist in table 020062')